...
const HELP_GROUPS: HelpGroup[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The screen icon (top-left) opens a fullscreen map with flight-timer buttons below it, handy for practicing patterns. The crosshair icon follows your live GPS position. The (i) icon opens a drawer with nearby radio frequencies and an airspace-ceiling check, without leaving this view — see \"Airspace & nearby info\" below. The ⚠ icon is engine-out targeting — see \"Engine out\" above. The ↩ icon undoes the last route edit, same as the \"Undo\" button below the waypoint list. The small dial (bottom-right) rotates the map — drag it to point any direction up; double-click/tap it to reset to north-up. All the map's own buttons (zoom, fullscreen, follow, info, engine-out, undo, layers) are sized for easy use one-handed in flight.",
