...
const HELP_GROUPS: HelpGroup[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Below that, a turn coordinator: the banking-aircraft symbol shows rate of turn (wingtip aligns with the amber dot at exactly standard rate — 3°/sec, a 2-minute turn), derived from how fast the compass heading is changing rather than a raw gyroscope reading, same reason the bearing line above avoids needing to know which axis is \"yaw\" for however the phone is mounted. The ball below it is a slip/skid indicator — it compares your actual bank to the bank a coordinated turn would need at your current turn rate and GPS ground speed (a stand-in for true airspeed, since a phone can't measure that directly — close enough at typical LSA speeds without being exact). Needs GPS speed above roughly 20kt to mean anything; shows grey and centered below that rather than a number that isn't real. \"Invert slip/skid\" is there if it reads backwards for your particular mount, same idea as the pitch/bank invert checkboxes."
    ]
  },
  {
